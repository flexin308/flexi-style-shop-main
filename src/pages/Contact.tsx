              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-700">
                    We offer premium quality fashion and accessories, which means they are meticulously crafted with exceptional attention to design, materials, and finish. Our products meet high standards of quality and craftsmanship with excellent attention to detail.
                  </p>
                </div>
